...
$logFile = "C:\SDPU\Test\log file\SV-253392_LogFile.txt"

#Define the registry path and expected value
$registryPath = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\DataCollection"
$registryValueName = "LimitEnhancedDiagnosticDataWindowsAnalytics"
$expectedValue = 1
...
"Script execution completed." | Out-File -FilePath $logFile -Append